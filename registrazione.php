...
<body>
    <div class="contenitore_login">
        ...
        <h2>Inserisci le tue credenziali:</h2>
            ...
            <table>
                <tr>
                    <td>Nome:</td> <td><input type="text" name="Nome" <?php echo "value = '$Nome'" ?> required></td>
                </tr>
                <tr>
                    <td>Cognome:</td> <td><input type="text" name="Cognome" <?php echo "value = '$Cognome'" ?> required></td>
                </tr>
                <tr>
                    <td>Email:</td> <td><input type="text" name="E_mail" <?php echo "value = '$E_mail'" ?> required></td>
                </tr>
                <tr>
                    <td>Password:</td> <td><input type="password" name="Password" <?php echo "value = '$Password'" ?> required></td>
                </tr>
                <tr>
                    <td>Conferma Password:</td> <td><input type="password" name="Conferma_Password" <?php echo "value = '$Conferma_Password'" ?> required></td>
                </tr>
                <tr>
                    <td>Numero di telefono:</td> <td><input type="text" name="Numero_telefono" <?php echo "value = '$Numero_telefono'" ?> required></td>
                </tr>
                <tr>
                    <td>Città:</td> <td><input type="text" name="Città" <?php echo "value = '$Città'" ?> required></td>
                </tr>
                <tr>
                    <td>Via:</td> <td><input type="text" name="Via" <?php echo "value = '$Via'" ?> required></td>
                </tr>
                <tr>
                    <td>Civico:</td> <td><input type="text" name="Civico" <?php echo "value = '$Civico'" ?> required></td>
                </tr>
                <tr>
                    <td>
                        <br>
